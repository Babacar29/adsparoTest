...
class FrgtPswdState extends State<ForgotPassword> {
  ...
  Widget backBtn() {
    return const Padding(padding: EdgeInsets.only(top: 30.0), child: CustomBackButton(horizontalPadding: 0));
  }
    ...
    return Container(
      ...
      child: Center(
        child: SvgPicture.asset(
          ...
          height: 150,
          fit: BoxFit.fill,
          colorFilter: ColorFilter.mode(adsBlueColor.withOpacity(0.7), BlendMode.srcIn),
        ),
      ),
    );
  }
